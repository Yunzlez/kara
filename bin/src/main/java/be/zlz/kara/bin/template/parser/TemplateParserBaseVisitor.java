...
public class TemplateParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements TemplateParserVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitPlaceholder(TemplateParser.PlaceholderContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitIter(TemplateParser.IterContext ctx) { return visitChildren(ctx); }
}